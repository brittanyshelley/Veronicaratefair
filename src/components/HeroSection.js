...
const HeroSection = () => {
  return (
    <div data-theme="mytheme">
      <div className={styles.hero} style={{ backgroundImage: `url('/vj-von-art-BP1Ze0qcp-c-unsplash.jpg')` }}>
        <div className={styles.heroOverlay}></div>
        <div className={`${styles.heroContent} text-accent`}>
          <div className="max-w-md mx-auto">
            <h1 className={`mb-5 text-5xl font-bold ${styles.textShadow}`}>Getting a Mortgage doesn&apos;t have to be complicated</h1>
            {/* <button className="btn btn-primary">Free Consultation</button> */}
          </div>
        </div>
      </div>
